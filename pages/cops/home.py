from pages.cops.base import Page
from regions.cops.base import Region
...
class Home(Page):
    _create_new_pdf_button_locator = (
        By.CSS_SELECTOR,
        "#app > div > main > div > div > div > div > div.text-right > button > span",
    )
    ...
    _previous_page_button_locator = (
        By.CSS_SELECTOR,
        "#app > div > main > div > div > div > div > div.d-md-flex > button:nth-child(1) > span",
    )
    _next_page_button_locator = (
        By.CSS_SELECTOR,
        "#app > div.v-application--wrap > main > div > div > div > div > div.d-md-flex > "
